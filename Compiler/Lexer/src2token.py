...
KEYWORDS = {
    ...
    "type", "inherits", "forks", "new", "fixed", "constant", "uses", "symbol",
    ...
    "size", "change", "absval",
    "int", "integer", "float", "double", "string", "bool", "none", "complex", "char",
...
def tokenize(src, filename="<source>"):
    ...
    while pos < len(src):
        ...
        # ── @ mod prefix ──────────────────────────────────────────────────────
        # @ always precedes a modifier name like @async, @nullable, @embedcall.
