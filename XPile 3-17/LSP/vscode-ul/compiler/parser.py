...
class Parser:
    ...
    def parse_function(self):
        ...
        # Extract nested function declarations from body
    ...
    def parse_body(self):
        ...
        while not self.at_end():
            ...
            if tok[0] == "KW" and tok[1] in ("end", "else"):
                break
    ...
    def parse_statement(self):
        ...
        if tok[0] == "KW":
            if tok[1] == "function": return self.parse_function()
            ...
            if tok[1] == "fixed":    return self.parse_var_decl()
    ...
    def parse_for(self):
        ...
        self.expect("KW", "end")
        self.expect("KW", "for")
        return For(var, iterable, body, line, col)
    ...
    def parse_comparison(self):
        ...
        CMP = {"==", "!=", "<", ">", "<=", ">="}
        while self.peek()[0] == "OP" and self.peek()[1] in CMP:
            op = self.advance()
    ...
    def parse_postfix(self):
        ...
        while True:
            ...
            if self.check("LPAREN"):
                ...
                if not self.check("RPAREN"):
                    ...
                    while self.match("COMMA"):
                        args.append(self.parse_expr())
                self.expect("RPAREN")
                # calls are always on a plain identifier at this stage
            ...
            # array index
                ...
                expr = Index(expr, idx, tok[2], tok[3])
            # cast: change(x)->type
            elif self.check("OP", "->"):
                tok = self.advance()
