...
GLOSSARY = {
    ...
    "killswitch": "Runtime assertion — active when @dr safety = checked, compiled out when unchecked.",
    "goto":       "Jumps execution to a portal label in the same function. (Alias: teleport)",
    "teleport":   "Alias for 'goto' — jumps to a portal label (legacy name).",
    "portal":     "Declares a named jump target for goto.",
    "try":        "Opens a try block for exception handling. Closed with 'end try'.",
    "catch":      "Catches an exception type in a try block. 'catch Type as name' binds the message.",
    "finally":    "Block that always executes after a try, whether or not an exception occurred.",
    "throw":      "Raises an exception. Syntax: throw ExceptionType message_expr.",
    ...
    # bitwise operators
    "both1":      "Bitwise AND of two values. (Alias: band, bit_and)",
    "both0":      "Bitwise NOR of two values.",
    "either1":    "Bitwise OR of two values. (Alias: bor, bit_or)",
    "diff":       "Bitwise XOR of two values. (Alias: delta, bit_xor)",
    "delta":      "Alias for 'diff' — bitwise XOR (legacy name).",
    "bitflip":    "Bitwise NOT (one's complement). (Alias: bnot, bit_not)",
    "negate":     "Arithmetic negation (two's complement).",
    "left":       "Bitwise left-shift (also 'left=' for compound). (Alias: lshift, bit_left)",
    "right":      "Bitwise right-shift (also 'right=' for compound). (Alias: rshift, bit_right)",
    ...
    # result types
    "ok":         "Success variant of a Result type.",
    "error":      "Error variant of a Result type.",
    "some":       "Present variant of an Optional type (reserved).",

    # new bitwise aliases
    "bit_and":    "Bitwise AND operator. (Alias: both1, band)",
    "bit_or":     "Bitwise OR operator. (Alias: either1, bor)",
    "bit_xor":    "Bitwise XOR operator. (Alias: diff, delta)",
    "bit_not":    "Bitwise NOT operator. (Alias: bitflip, bnot)",
    "bit_left":   "Bitwise left-shift operator. (Alias: left, lshift)",
    "bit_right":  "Bitwise right-shift operator. (Alias: right, rshift)",
    "xor":        "Logical XOR operator (boolean).",
    "char_code":  "Returns the integer code-point of a character. Usage: char_code(s, i).",
    "sort":       "Sorts an array in-place. Usage: sort(arr, n) or arr.sort().",

    # system functions
    "random":     "Returns a random float between 0.0 and 1.0. Builtin. (Alias: rand)",
    "random_int": "Returns a random integer in [lo, hi]. Usage: random_int(lo, hi). (Alias: rand_int)",
    "random_seed":"Sets the random number generator seed. Usage: random_seed(n). (Alias: rand_seed)",
    "userinput":  "Returns command-line arguments as array string. Index 0 = program name. (Alias: args)",
}
