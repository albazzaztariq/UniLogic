...
int main(void)
{
    ...
    snprintf(_cast_buf_0, sizeof(_cast_buf_0), "%d", 42);
    char* s = _cast_buf_0;
    printf("%s\n", s);
    double g = ((double)10);
    __ul_print_float((double)(g));
    int b1 = ((int)1);
    printf("%s\n", (b1) ? "True" : "False");
    int b2 = ((int)0);
    printf("%s\n", (b2) ? "True" : "False");
    ...
    snprintf(_cast_buf_1, sizeof(_cast_buf_1), "%d", score);
    char* msg = __ul_strcat("Score: ", _cast_buf_1);
    printf("%s\n", msg);
    return 0;
}
