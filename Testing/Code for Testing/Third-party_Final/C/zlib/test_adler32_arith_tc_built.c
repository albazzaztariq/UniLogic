...
uint64_t adler32_hello_world(void);
uint64_t adler32_empty(void);
uint64_t adler32_abc(void);
uint64_t adler32_lo(uint64_t adler);
uint64_t adler32_hi(uint64_t adler);
uint64_t adler32_combine(uint64_t adler1, uint64_t adler2, uint64_t len2);
uint64_t adler32_hello(void);
uint64_t adler32_world(void);
int main(void);
...
int main(void)
{
    ...
    snprintf(_cast_buf_0, sizeof(_cast_buf_0), "%u", r);
    printf("%s\n", __ul_strcat("adler32(\"\") = ", _cast_buf_0));
    r = adler32_abc();
    static char _cast_buf_1[64];
    snprintf(_cast_buf_1, sizeof(_cast_buf_1), "%u", r);
    printf("%s\n", __ul_strcat("adler32(\"abc\") = ", _cast_buf_1));
    r = adler32_hello_world();
    static char _cast_buf_2[64];
    snprintf(_cast_buf_2, sizeof(_cast_buf_2), "%u", r);
    printf("%s\n", __ul_strcat("adler32(\"Hello, World!\") = ", _cast_buf_2));
    lo = adler32_lo(r);
    hi = adler32_hi(r);
    recombined = (lo | (hi << 16));
    static char _cast_buf_3[64];
    snprintf(_cast_buf_3, sizeof(_cast_buf_3), "%u", lo);
    static char _cast_buf_4[64];
    snprintf(_cast_buf_4, sizeof(_cast_buf_4), "%u", hi);
    static char _cast_buf_5[64];
    snprintf(_cast_buf_5, sizeof(_cast_buf_5), "%u", recombined);
    ...
    uint64_t x = 3735928559LL;
    uint64_t y = ((x >> 16) & 65535);
    uint64_t z = (x & 65535);
    uint64_t w = (y | (z << 16));
    static char _cast_buf_12[64];
    snprintf(_cast_buf_12, sizeof(_cast_buf_12), "%u", x);
    static char _cast_buf_13[64];
    snprintf(_cast_buf_13, sizeof(_cast_buf_13), "%u", y);
    static char _cast_buf_14[64];
    snprintf(_cast_buf_14, sizeof(_cast_buf_14), "%u", z);
    static char _cast_buf_15[64];
    snprintf(_cast_buf_15, sizeof(_cast_buf_15), "%u", w);
