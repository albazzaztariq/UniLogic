...
int cmark_isspace(int c)
{
    return (cmark_ctype_class[((int)c)] == 1);
}

int cmark_ispunct(int c)
{
    return (cmark_ctype_class[((int)c)] == 2);
}

int cmark_isdigit(int c)
{
    return (cmark_ctype_class[((int)c)] == 3);
}

int cmark_isalpha(int c)
{
    return (cmark_ctype_class[((int)c)] == 4);
}
