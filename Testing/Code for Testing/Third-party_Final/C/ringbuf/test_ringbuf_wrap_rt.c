...
void advance_head(ringbuf_t* rb, int n);
int main(void);
...
int main(void)
{
    ...
    printf("%s\n", __ul_strcat("buf=%p end=%p size=", _cast_buf_0));
    advance_head((&rb), 4);
    static char _cast_buf_1[64];
    snprintf(_cast_buf_1, sizeof(_cast_buf_1), "%d", ((int)(rb.head - rb.buf)));
    printf("%s\n", __ul_strcat("after advance CAPACITY: head_offset=", _cast_buf_1));
    ...
    snprintf(_cast_buf_2, sizeof(_cast_buf_2), "%d", ((int)(rb.head - rb.buf)));
    printf("%s\n", __ul_strcat("after manual wrap: head_offset=", _cast_buf_2));
    ...
    snprintf(_cast_buf_3, sizeof(_cast_buf_3), "%d", ((int)(rb.tail - rb.buf)));
    printf("%s\n", __ul_strcat("after tail wrap: tail_offset=", _cast_buf_3));
    return 0;
}
